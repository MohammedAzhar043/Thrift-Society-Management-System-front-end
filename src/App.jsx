...
import FullPageReport from "./components/admin/FullPageReport";
      ...
      <div className="min-h-screen bg-gray-100">
        <Routes>
          ...
          <Route
            ...
            element={
              user?.role &&
              ["billcollector", "collector"].includes(
          ...
          <Route
            ...
            element={
              user?.role &&
              ["teamleader", "team_leader"].includes(
                user.role.toLowerCase()
              ) ? (
          ...
          <Route
            ...
            element={
              user?.role &&
              ["member", "individual_member"].includes(
                user.role.toLowerCase()
              ) ? (
          ...
          <Route
            ...
            element={
              user?.role &&
              ["adminclerk", "clerk"].includes(user.role.toLowerCase()) ? (
          ...
          <Route
            ...
            element={
              user?.role && ["admin", "adminclerk", "clerk"].includes(user.role.toLowerCase()) ? (
                <FullPageReport user={user} />
              ) : (
                <Navigate to="/login" />
              )
            }
