    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-r text-black py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link
            to="/login"
            className="bg-white text-blue-800 px-6 py-3 rounded-md font-medium text-lg hover:bg-blue-50 transition-colors inline-block"
          >
            Get Started
          </Link>
        </div>
      ...
      <footer className="bg-gray-800 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <p>
            &copy; {new Date().getFullYear()} Thrift Society Management System.
            All rights reserved.
          </p>
        </div>
      </footer>
